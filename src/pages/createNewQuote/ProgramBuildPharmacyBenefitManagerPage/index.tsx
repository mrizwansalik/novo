...
import {
  ContentContainer,
  PageContainer,
} from "./programBuildPharmacyBenefitManagers.styles";

const ProgramBuildPharmacyBenefitManagerPage = () => {
  ...
  return (
    <PageLayout title="Add Pharmacy Benefit Manager | Novo Connection">
      <PageContainer>
        <LoadingBar
...
export default observer(ProgramBuildPharmacyBenefitManagerPage);
