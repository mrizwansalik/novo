...
export const StyledContainer = styled(ReactStrapContainer)`
  margin-top: 16px;
  margin-bottom: 20px;
  border: 1px solid ${ThemeColor.BORDER_COLOR};
...
export const StyledLabel = styled.label<{ noMarginBottom?: boolean }>`
  display: block;
  margin-bottom: 1px;
  margin-top: 22px ${(props) => props.noMarginBottom && `margin-bottom: 0px`};
`;
...
export const TableTemplate = styled.div`
  border-bottom: 1px solid #c8c8c8 !important;
  margin-top: 10px;
  margin-left: 10px;
...
`;
export const Togglebutton = styled(Switch)<{ checked: boolean }>`
