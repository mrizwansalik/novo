...
import { getAmountTypeOptions, getSubNetworkTypeOptions } from "./constants";
import {
  Container,
  CommonTitle,
  CommonInput,
  ...
  return (
    <Container>
      ...
      <ColNoSpacing xl="12" lg="12" md="12" sm="12" xs="12">
        <CommonTitle>Type</CommonTitle>
        <LargeSpacing>
          <Controller
            name={SubNetworkFormValues.SUB_NETWORK_TYPE}
            control={control}
            defaultValue={getSubNetworkTypeOptions()[0]}
            render={({ field }) => (
              <CommonSelect
                {...field}
                options={getSubNetworkTypeOptions()}
                defaultValue={getSubNetworkTypeOptions()[0]}
              />
            )}
          />
